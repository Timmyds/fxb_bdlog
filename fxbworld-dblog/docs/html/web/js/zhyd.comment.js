 ...
 * @author fxb(yadong.zhang0415#gmail.com)
    ...
    comment: {
        ...
        init: function (options) {
            ...
            var commentBox = '<div id="comment-place">'
                    ...
                    + '<div style="position: absolute;right: 10px;bottom: 65px;font-size: 14px;font-weight: 700;color: #ececec;">博客<br> <br>讲文明、要和谐</div>'
