<footer>
    <div class="pull-right">
        Copyright © 2017 fxb.me. All Rights Reserved. Current version is 1.0.
    </div>
...
<script src="/assets/js/fxb.tool.js"></script>
<script src="/assets/js/fxb.upload-preview.js"></script>
<script src="/assets/js/fxb.core.js"></script>
<script src="/assets/js/fxb.table.js"></script>
</body>
</html>