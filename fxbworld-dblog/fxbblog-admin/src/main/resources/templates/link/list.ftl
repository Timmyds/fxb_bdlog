            ...
            columns: [
                {
                    ...
                    formatter: function (code) {
                        ...
                        return '<a href="javascript:void(0);" target="_blank" onclick="window.open(\'tencent:\/\/message\/?uin=' + code + '&amp;Site=www.fxb.me&amp;Menu=yes\')" rel="external nofollow"><i class="fa fa fa-qq fa-fw"></i></a>';
                    }
                },  {
                    field: 'remark',
                    title: '备注',
