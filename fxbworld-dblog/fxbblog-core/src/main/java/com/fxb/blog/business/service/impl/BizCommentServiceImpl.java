...
import com.fxb.blog.business.dto.BizCommentDTO;
...
import com.fxb.blog.persistence.beans.BizComment;
import com.fxb.blog.persistence.mapper.BizCommentMapper;
import com.fxb.blog.util.BeanConvertUtil;
import com.fxb.blog.util.HtmlUtil;
import com.fxb.blog.util.IpUtil;
import com.fxb.blog.util.RestClientUtil;
import com.fxb.blog.util.UrlBuildUtil;
...
//            String street_number = addressDetail.getString("street_number");
    ...
    public void doSupport(Long id) {
        ...
        if (redisTemplate.hasKey(key)) {
            throw new CommentException("一个小时只能点一次赞哦~");
        }
