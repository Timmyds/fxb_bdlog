...
import com.fxb.blog.business.entity.*;
...
import com.fxb.blog.util.FreeMarkerUtil;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendToAdmin(Link link) {
        ...
        adminEmail = StringUtils.isEmpty(adminEmail) ? "fxbworld@163.com" : (adminEmail.contains("#") ? adminEmail.replace("#", "@") : adminEmail);
