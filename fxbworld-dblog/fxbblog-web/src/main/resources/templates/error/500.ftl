            ...
            <div class="blog-body">
                <div class="error-container">
                    ...
                    <div>
                        ...
                        <ul>
                            <li>稍后重试</li>
                            <li>联系<a target="_blank" href="javascript:void(0);" title="点击QQ联系我"onclick="window.open('tencent://message/?uin=390156604&amp;Site=www.${config.domain}&amp;Menu=yes')" rel="external nofollow">网站管理员</a></li>
                        </ul>
