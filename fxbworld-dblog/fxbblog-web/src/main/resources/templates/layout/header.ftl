    ...
    <div class="menu-box">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <div class="pull-left site-desc" style="line-height: 0.9;">
                <h1 style="font-size: 20px;font-weight: 700;" class="auto-shake"><a href="${config.siteUrl}" data-original-title="摄影、旅游、户外" data-toggle="tooltip" data-placement="bottom">${config.siteName}</a></h1>
                <p class="site-description">摄影、旅游、户外</p>
            </div>
