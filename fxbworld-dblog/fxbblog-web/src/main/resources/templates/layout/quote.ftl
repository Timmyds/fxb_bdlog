    ...
    <link href="${config.staticWebSite}/css/fxb.core.css" rel="stylesheet" type="text/css">
    <link href="${config.staticWebSite}/css/fxb.comment.css" rel="stylesheet" type="text/css">