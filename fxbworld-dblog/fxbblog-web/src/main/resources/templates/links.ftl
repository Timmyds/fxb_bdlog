...
<@header title="友情链接 | ${config.siteName}"
    ...
    description="${config.siteName}，个人分享、摄影、旅游、户外，友情链接交换"
    canonical="/links">
</@header>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 blog-main">
            <div class="blog-body expansion">
                ...
                <h4 class="bottom-line"><i class="fa fa-coffee fa-fw"></i><strong>简单的说明</strong></h4>
                <div class="link-info">
                    <ul class="list-unstyled">
                        <li>本站定位：个人分享</li>
                        <li>本站作用：摄影、旅游、户外等分享</li>
                        <li>本站 <em>优先</em> 选择同类原创、内容相近的网站，您的站点内容可以为<kbd>摄影</kbd>、<kbd>旅游</kbd>、<kbd>户外</kbd>、<kbd>游记</kbd>和<kbd>生活</kbd></li>
                        <li>特别提醒：<abbr title="禁止友链的网站">谢绝任何包含违反国家法律法规内容的网站、盈利类（赌博）网站，还有相亲类等等！！！</abbr></li>
                        <li>
                            <blockquote>
                                <ul class="list-unstyled">
                                    <li>复制添加本站链接：<strong>&lt;a href="${config.siteUrl}" title="${config.siteDesc}" target="_blank"&gt;XXXXX&lt;/a&gt;</strong></li>
